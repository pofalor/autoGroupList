...
-- Добавляем студентов
INSERT INTO Students (name, number_in_group, subgroup) VALUES
('Абделфаттах Ахмед', 1, 'subgroup1'),
('Абейдуллов Алмаз', 2, 'subgroup1'),
('Аль-Гурайри Зайд', 3, 'subgroup2'),
('Ахметгалеев Ислам', 4, 'subgroup2'),
('Багаутдинов Артём', 5, 'subgroup2'),
('Валиев Нияз', 6, 'subgroup2'),
('Габдулхаков Разиль', 7, 'subgroup2'),
('Гаврилов Николай', 8, 'subgroup2'),
('Галимуллин Марсель', 9, 'subgroup2'), -- Добавлен новый студент
('Гатауллин Тимур', 10, 'subgroup2'), -- Номер увеличен на 1
('Громов Даниил', 11, 'subgroup2'),  -- Номер увеличен на 1
('Елазаб Мохамед', 12, 'subgroup2'),  -- Номер увеличен на 1
('Йолдошева Умидабону', 13, 'subgroup2'), -- Номер увеличен на 1
('Марцинко Александр', 14, 'subgroup2'), -- Номер увеличен на 1
('Миндубаев Инсаф', 15, 'subgroup2'),  -- Номер увеличен на 1
('Мохамед Магед', 16, 'subgroup2'),  -- Номер увеличен на 1
('Муфтиев Ильяс', 17, 'subgroup2'), -- Номер увеличен на 1
('Саниев Руслан', 18, 'subgroup2'), -- Номер увеличен на 1
('Сафиуллин Ранис', 19, 'subgroup2'),  -- Номер увеличен на 1
('Тихонов Андрей', 20, 'subgroup2'),  -- Номер увеличен на 1
('Французов Денис', 21, 'subgroup2'), -- Номер увеличен на 1
('Хамидуллин Булат', 22, 'subgroup2'),  -- Номер увеличен на 1
('Хузиев Ратмир', 23, 'subgroup2'), -- Номер увеличен на 1
('Хузин Камиль', 24, 'subgroup2'),  -- Номер увеличен на 1
('Шагеева Лейла', 25, 'subgroup2'), -- Номер увеличен на 1
('Шайдуллин Марсель', 26, 'subgroup2'),  -- Номер увеличен на 1
('Щеняев Ярослав', 27, 'subgroup2'); -- Номер увеличен на 1
...
(11, 569209035);  -- student_id = 11, telegram_id = 569209035